...
7. **Kuramoto Bloom** — coupling term `sin(φ₁−φ₂)` folded into the phase of every mode in a small ring of harmonics, plus a coherent backbone along the lock diagonal. The synchronization bifurcation made into a feature of the surface itself, not just a property of the scan. Added 2026-06-06; see [[16 — Kuramoto Bloom]].
8. **Matérn Field** — a seeded realization of a Matérn Gaussian random field synthesized on the integer torus lattice. Statistically specified rather than hand-drawn; warm and smooth, with the spectral decay set by ν and ℓ. Added 2026-06-06; see [[17 — Matérn Field]].
9. **Fisher Ridge** — the log-likelihood of a five-mode von Mises mixture on T². Ridges are the high-Fisher-information seams where neighboring modes hand off; scan paths that cross seams produce snap transitions in the output. Added 2026-06-06; see [[18 — Fisher Ridge]].

The library is open — these nine are seeds, not a closed set. Surfaces 7–9 were added together on Loudon's 2026-06-05 instruction "open up more slots, expand the project and include all of these"; together they close the five-generating-logics inventory the design language promised, by giving Logics 3, 4, and 5 their first concrete surface each.
...
- ~~**The seventh surface.**~~ **Resolved 2026-06-06.** Loudon expanded the slot to three, accepting all three candidates auditioned 2026-06-03 ([[16 — Kuramoto Bloom]], [[17 — Matérn Field]], [[18 — Fisher Ridge]]) as permanent catalog entries — one per remaining generating logic. The "open seventh slot" is replaced by an open-ended Tier 2 range; future expansions are additive, not slot-filling.
