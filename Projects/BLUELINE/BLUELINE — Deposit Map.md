...
4. **Staging-AI primary** — ✅ **going in betting on Blender-MCP (#1), SceneCraft (#2), close.** The Claude Code job's Session 2 bake-off confirms or upsets this prior; Loudon decides after.
