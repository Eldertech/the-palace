#!/usr/bin/env python3
"""Track IV post-step (comfy venv): draw the geometric OpenPose skeleton from the
bench's keypoints, and the canny EDGE from the RGB. Completes each board's passes."""
import os, json, glob
import numpy as np
