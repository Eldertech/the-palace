#!/usr/bin/env python3
"""New-story post-step (comfy venv): draw the geometric OpenPose skeleton from newstory_bench's
keypoints, and the canny EDGE from the RGB. Same logic as the Track IV bench post.py."""
import os, json, glob
import numpy as np
...
import staging_skeleton as SK            # ONE skeleton — canonical OpenPose colours from the shared module
