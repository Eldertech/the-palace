...
**1. Name the question.** Identify a problem, design decision, or conceptual territory where multiple genuine philosophical positions exist. The question should be one where the disagreement between positions is productive rather than merely semantic.

**2. Identify the voices.** Select two to four thinkers, practitioners, or traditions whose work genuinely addresses the question from different angles. The selection should be based on real intellectual divergence — not a spectrum of agreement but a set of genuinely different orientations.

**3. Research before embodying.** Before writing a word of dialogue, gather enough biographical, intellectual, and stylistic material to embody each voice faithfully. What did they actually care about? What were their characteristic moves — the arguments they reached for, the examples they used, the objections they dismissed too quickly? What were their blindspots? A thinker poorly researched produces a caricature. A thinker deeply researched produces a voice that surprises you.

**4. Enter the dialogue.** Set the scene, introduce the question, and let the voices respond. The goal is not balance or fairness — it is fidelity. Each voice should argue for its own position with genuine conviction, push back on the others with genuine force, and occasionally say something that neither Loudon nor Claude would have said without the embodiment.

**5. Let the dialogue turn.** The most valuable moments are when the conversation changes direction — when one voice concedes something unexpected, or when the question itself gets reframed by the collision of perspectives. These turns are where the method earns its value. Follow them rather than resolving them prematurely.

**6. Extract and name.** After the dialogue, step back and identify what the dialogue produced that no single voice could have produced alone. These extractions are the intellectual yield.
