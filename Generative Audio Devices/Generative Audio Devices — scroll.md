...
_No steward has spoken for this project. Its direction is the `forward_vector` in [[Generative Audio Devices]]'s frontmatter; enchant a steward to start the trail._
