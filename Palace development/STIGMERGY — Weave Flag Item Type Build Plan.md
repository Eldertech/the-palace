...
- **Deposit Ceremony lives at `_ops/Deposit Ceremony.md`.** Step 7b currently says: append a one-line record to Deposit Archive; git commit. That is where the new line lands.
