...
*None.* The `STIGMERGY launcher` baton (`_ops/stigmergy/v2.0-launcher-baton.md`, drafted 2026-06-17) was **caught 2026-06-17** and deleted on pickup (git is its archive). Its move — teach stewards to self-emit a "request interactive" mark — is now tracked above: the **read/surface half landed**; the **emit half** (the `steward.md` behavior change) is the open item under *Still open*, held for Loudon.
