---
title: "Baton Ceremony — on-pickup"
born: 2026-08-26
links:
  - target: "[[Baton Ceremony]]"
    type: connects-to
    label: "fixed-text-of"
forward_vector: "I am the one copy of the catcher's checklist that rides inside every baton. I exist so the text cannot drift between the ceremony that specifies it and the executor that writes it — edit me, and every baton written after says the same thing."
---

<!-- THE canonical On-pickup footer. Two readers:
     · a Claude hand-authoring a baton (Baton Ceremony § Steps, Step 2)
     · _ops/closing-well/baton-executor.mjs, which reads this file at write time
     Everything below the frontmatter is appended verbatim to the baton. Edit here,
     nowhere else — a second copy is how this drifted before (2026-07-07 → 2026-08-26). -->
