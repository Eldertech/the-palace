...
|---|---|---|---|---|---|
| 2026-03-27 | full | tsv+json+adjacency | 94 nodes | 544 edges | 15 ghosts |

| 2026-03-27 | full (v2 ceremony) | tsv+json+adjacency | 94 nodes | 543 edges | 7 forward ghosts | 4 Pillars Framework - The Founding Conversation, 4 Pillars Weekly Structure, Ableton Extension SDK, Donella Meadows, Dub Lineage, Octave Equivalence, Resonance and Damping |
...
| 2026-06-16 | full (deep weave — v1.13 frontmatter-driven builder supersedes 06-07; 23 member-of upgrades, 79 unsung paths, 12 theme-ghost links removed, 4 E1 contradictions resolved, Donella Meadows duplicate merged) | tsv+json+adjacency | 309 nodes | 1955 edges | 23 forward ghosts | Capability-first prototyping, Convolution, Resonance and Damping, Toolkit — Audio Effects/Drum Machines/MIDI Controllers, Actor Model, Leibniz (monadology), Haas Effect, Ableton Extension SDK, and 15 others |
| 2026-07-04 | full (bundle-hygiene sweep — ~49 working-docs demoted to §8 bundle files + dropped from nodes incl. 19 dash-named plans/context/build-logs found via this map, 9 stale plans deleted, 16 files renamed to convention, 2 Dialectics re-promoted to breakthrough, 1 error-ghost fixed) | json+tsv+adjacency | 306 nodes | 2512 edges | 53 forward ghosts | Capability-first prototyping, and the demoted context/plan companions (now accepted forward-ghosts like Closing Well — Context), Convolution, Trickster (Loudon), Actor Model, Resonance and Damping, and others |
