...
| `spec` | A specification for one deliverable to be built or dispatched — a patch spec, visuals spec, SFX cue sheet, imagery brief, or the Loudon Live session designs for a plan's moves. The recipe for a single owned artifact, not the artifact itself; typically routed through [[The Shop]] / a Maker. |
