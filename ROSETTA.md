...
| **Enrichment** | "enrich [page]" / "enrich this page" | One entry, read whole with its bundle | The whole Shop makes the page's rich face — sound, image and interactives beside its headings, via a manifest in the bundle; pieces test the text, and what making teaches goes home as an edit | Every manifest section *in step*; pieces in the bundle; the door line in the entry; the page renders at `/rich/` | [[Enrichment]] |
