---
title: "1 from 2 — scroll"
born: 2026-09-23
links:
  - target: "[[1 from 2]]"
    type: connects-to
    label: scroll-for
forward_vector: "I am 1 from 2's scroll — the one page that always opens on where the project stands now, then reads down through everything it has made, newest first. My top is regenerated from the board and the palace whenever anyone looks; my standing orders are Loudon's and never regenerated; my trail only ever grows."
---

# 1 from 2 — scroll

> The project's front door. **Now** is regenerated on every look; **Standing Orders** are Loudon's; **The making** is the trail, newest first. Rendered in [[STIGMERGY]]'s PROJECTS deck; the entry [[1 from 2]] stays the considered truth and this is the live one. See [[The Scroll]].
...
_No steward has spoken for this project. Its direction is the `forward_vector` in [[1 from 2]]'s frontmatter; enchant a steward to start the trail._
