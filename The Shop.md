...
<!-- ROSTER:START — generated by Shop/Maker/build-roster.mjs; do not edit by hand -->
...
**30 Specialists** — 25 alive · 4 stub · 1 deprecated. **Makers:** [[Hero and Avatar Maker]] (alive) · [[Maker]] (alive) · [[Shopkeeper]] (alive).

| Specialist | Status | Medium | Tool |
|---|---|---|---|
| [[Shop/Blender\|Blender]] | alive | image | blender |
| [[Shop/ComfyUI\|ComfyUI]] | alive | image | comfyui |
| [[Shop/D3.js\|D3.js]] | alive | interactive | d3.js |
| [[Shop/Depth Anything\|Depth Anything]] | alive | other | Depth Anything V2 |
| [[Shop/ffmpeg\|ffmpeg]] | alive | plumbing | ffmpeg |
| [[Shop/Figure Rig\|Figure Rig]] | alive | image | blender |
| [[Shop/FLUX (Hugging Face)\|FLUX (Hugging Face)]] | alive | image | flux.1-krea-dev (hf-inference-api) |
| [[Shop/Kokoro\|Kokoro]] | alive | sound | kokoro |
| [[Shop/LaMa\|LaMa]] | alive | other | LaMa (simple-lama-inpainting) |
| [[Shop/Lettering\|Lettering]] | alive | image | ComfyUI SDXL + ControlNet-canny (render_text.py) |
| [[Shop/LoRA Trainer\|LoRA Trainer]] | alive | image | ai-toolkit (ostris) · kohya-ss/sd-scripts |
| [[Shop/Manim CE\|Manim CE]] | alive | motion | manim-ce |
| [[Shop/Matplotlib\|Matplotlib]] | alive | image | matplotlib |
| [[Shop/Mermaid\|Mermaid]] | alive | image | mermaid |
| [[Shop/OBS\|OBS]] | alive | motion | obs-studio |
| [[Shop/Observable Plot\|Observable Plot]] | alive | interactive | observable-plot |
| [[Shop/p5.js\|p5.js]] | alive | interactive | p5.js |
| [[Shop/Remotion\|Remotion]] | alive | motion | remotion |
| [[Shop/SAM\|SAM]] | alive | other | Segment Anything (ultralytics) |
| [[Shop/Stable Audio Open\|Stable Audio Open]] | alive | sound | stable-audio-3 |
| [[Shop/Three.js\|Three.js]] | alive | interactive | three.js |
| [[Shop/Tone.js\|Tone.js]] | alive | interactive | tone.js |
| [[Shop/VCV Patch Generator\|VCV Patch Generator]] | alive | sound | vcv-patch-generator |
| [[Shop/Web Audio Worklet\|Web Audio Worklet]] | alive | interactive | Web Audio API (AudioWorklet) |
| [[Shop/Whisper\|Whisper]] | alive | sound | whisper |
| [[Shop/AuK\|AuK]] | stub | sound | AuK (Tencent) — via the tencent/AuK HF Space |
| [[Shop/Image-to-3D Smith\|Image-to-3D Smith]] | stub | image | Hi3DGen (primary) · Hunyuan3D-2 (fast fallback) · TRELLIS.2 (display-optimized) · TripoSplat (splat lane) |
| [[Shop/LaTeX\|LaTeX]] | stub | other | latex |
| [[Shop/RNBO codebox~ smith\|RNBO codebox~ smith]] | stub | sound | rnbo-codebox |
| [[Shop/Midjourney\|Midjourney]] | deprecated | image | midjourney |
<!-- ROSTER:END -->
